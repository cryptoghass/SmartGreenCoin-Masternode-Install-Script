...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='SmartGreenCoin.conf'
CONFIGFOLDER='/root/.SmartGreenCoin'
COIN_DAEMON='SmartGreenCoind'
COIN_CLI='SmartGreenCoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/smartgreencoin/SmartGreenCoin/releases/download/v1.0.1/SmartGreenCoin-1.0.1-x86_64-linux-gnu.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='SmartGreenCoin'
COIN_PORT=59235
RPC_PORT=59234
